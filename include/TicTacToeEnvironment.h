...
public:
     ...
     * 
     * @param illegalMoveReward
     * @param legalNonEndingMoveReward
     * @param winReward
     * @param drawReward
     * @param lossReward
     */
    TicTacToeEnvironment(float illegalMoveReward = -50, float legalNonEndingMoveReward = 50,
                         float winReward = 500, float drawReward = 0,
                         float lossReward = -500);
    ...
    int illegalMoves;
    int legalMoves;
    float illegalMoveReward;
    float legalNonEndingMoveReward;
    float winReward;
    float lossReward;
    float drawReward;
...
private:
    ...
    // global statistics to display in render
    int wins;
    int losses;
    int draws;
    int totalInvalidMoves;
    int totalMoves;
};
